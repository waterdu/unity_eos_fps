...
namespace Epic.OnlineServices.P2P
{
	...
	{
		public P2PInterface() : base(IntPtr.Zero)
		{
		}
		...
		/// <param name="outPacketSize">The amount of bytes required to store the data of the next packet for the requested user</param>
		/// <returns>
		/// <see cref="Result" />::<see cref="Result.Success" /> - If OutPacketSize was successfully set and there is data to be received
		/// <see cref="Result" />::<see cref="Result.InvalidParameters" /> - If input was invalid
