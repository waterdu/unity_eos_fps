...
namespace Epic.OnlineServices.Auth
{
	...
	public enum LoginCredentialType
	{
		...
		/// 
		/// On Console platforms, after a successful login using the <see cref="LoginCredentialType.DeviceCode" /> login type,
		...
		/// 1. Game initiates the user login flow by calling <see cref="AuthInterface.Login" /> API with the <see cref="LoginCredentialType.DeviceCode" /> login type.
		...
		/// To do this, after a successful login using the <see cref="LoginCredentialType.DeviceCode" /> login type, the game can call the <see cref="AuthInterface.CopyUserAuthToken" /> API
		...
		/// using the <see cref="LoginCredentialType.PersistentAuth" /> login type to automatically login the current local user of the device.
		/// </summary>
		DeviceCode = 3,
		/// <summary>
