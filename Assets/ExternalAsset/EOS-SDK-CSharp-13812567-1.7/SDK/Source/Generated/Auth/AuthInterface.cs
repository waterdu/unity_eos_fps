...
namespace Epic.OnlineServices.Auth
{
	...
	{
		public AuthInterface() : base(IntPtr.Zero)
		{
		}
		...
		/// </summary>
		/// <param name="index">an index into the list of logged in accounts. If the index is out of bounds, the returned account id will be invalid.</param>
		/// <returns>
		/// the account id associated with the index passed
		/// </returns>
