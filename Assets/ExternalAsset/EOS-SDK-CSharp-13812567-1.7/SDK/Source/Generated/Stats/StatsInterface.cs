...
namespace Epic.OnlineServices.Stats
{
	...
	{
		public StatsInterface() : base(IntPtr.Zero)
		{
		}
		...
		/// <param name="outAchievement">The stat data for the given index, if it exists and is valid, use <see cref="Release" /> when finished</param>
		/// <returns>
		...
		/// <param name="outAchievement">The stat data for the given name, if it exists and is valid, use <see cref="Release" /> when finished</param>
		/// <returns>
		/// <see cref="Result.Success" /> if the information is available and passed out in OutStat
		/// <see cref="Result.InvalidParameters" /> if you pass a null pointer for the out parameter
		/// <see cref="Result.NotFound" /> if the stat is not found
