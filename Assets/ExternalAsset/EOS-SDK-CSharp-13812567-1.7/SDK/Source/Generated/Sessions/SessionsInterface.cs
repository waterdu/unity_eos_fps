...
namespace Epic.OnlineServices.Sessions
{
	...
	{
		public SessionsInterface() : base(IntPtr.Zero)
		{
		}
		...
		/// </summary>
		public const int SessionmodificationMaxSessionAttributeLength = 32;
		...
		/// <summary>
		/// Update a session given a session modification handle created via <see cref="CreateSessionModification" /> or <see cref="UpdateSessionModification" />
		/// </summary>
		...
		/// <param name="clientData">Arbitrary data that is passed back to you in the CompletionDelegate</param>
		/// <param name="notification">A callback that is fired when a session invite for a user has been received</param>
		/// <returns>
