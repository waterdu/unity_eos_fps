...
namespace Epic.OnlineServices.Friends
{
	...
	{
		public FriendsInterface() : base(IntPtr.Zero)
		{
		}
		...
		/// </summary>
		/// <param name="options">structure containing the account id of the friends list</param>
		/// <returns>
		...
		/// <summary>
		/// Retrieves the account id of an entry from the friends list that has already been retrieved by the <see cref="QueryFriends" /> API.
		...
		/// To determine if the account id returned by this function is a friend or a pending friend invitation, use the <see cref="GetStatus" /> function.
		/// <seealso cref="GetFriendsCount" />
		/// <seealso cref="GetStatus" />
		/// </summary>
		/// <param name="options">structure containing the account id of the friends list and the index into the list</param>
		/// <returns>
		/// the account id of the friend. Note that if the index provided is out of bounds, the returned account id will be a "null" account id.
		/// </returns>
		...
		/// </summary>
		/// <param name="options">structure containing the account id of the friend list to check and the account of the user to test friendship status</param>
		/// <returns>
